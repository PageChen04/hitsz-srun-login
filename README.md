...
```console
./hitsz-srun-login -username <username> -password <password> [-bind <bind_ip>] [-dry-run] [-session-file <path>] [-no-session] [-non-interactive] [-mfa-method <sms|app|email|otp>] [-mfa-code <code>]
```
